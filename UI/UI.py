...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.layoutWidget.setGeometry(QtCore.QRect(10, 220, 221, 22))
        ...
        self.spinBox_y.setProperty("value", 2047)
        self.spinBox_y.setObjectName("spinBox_y")
        self.horizontalLayout.addWidget(self.spinBox_y)
        self.FittingButton = QtWidgets.QPushButton(self.groupBox_2)
        self.FittingButton.setGeometry(QtCore.QRect(10, 150, 75, 23))
        self.FittingButton.setObjectName("FittingButton")
        self.layoutWidget1 = QtWidgets.QWidget(self.groupBox_2)
        self.layoutWidget1.setGeometry(QtCore.QRect(10, 190, 126, 22))
        ...
        self.ChangeLineBox = QtWidgets.QSpinBox(self.layoutWidget1)
        self.ChangeLineBox.setMaximum(2048)
        self.ChangeLineBox.setObjectName("ChangeLineBox")
        self.horizontalLayout_2.addWidget(self.ChangeLineBox)
        ...
        self.label_6.setGeometry(QtCore.QRect(10, 730, 1071, 16))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.FittingButton.setText(_translate("MainWindow", "Fitting"))
        self.label_7.setText(_translate("MainWindow", "StartLine："))
        self.LoadButton_2.setText(_translate("MainWindow", "Next Line"))
        self.label_6.setText(_translate("MainWindow", "Message Status Bar"))
